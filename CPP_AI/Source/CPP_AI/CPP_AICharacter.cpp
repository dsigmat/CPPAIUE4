...
{
	// If CPP_AI is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in CPP_AI.Build.cs is not automatically propagated
